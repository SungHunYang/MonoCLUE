...
from .clustering import QueryInitializer
...
class Det2DTransformer(nn.Module):
    def __init__(
        ...
        self.query_init = QueryInitializer(d_model)
    ...
    def forward(self, srcs, masks, pos_embeds, region_mask, query_embed=None):
        ...
        deform_info = [spatial_shapes, level_start_index, valid_ratios, mask_flatten, lvl_pos_embed_flatten]
        tgt, memory = self.query_init(memory, region_mask, tgt, deform_info)
